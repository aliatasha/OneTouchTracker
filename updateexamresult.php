...
include('connect.php');
 ...
 else
 {
    ...
    $examid=$_GET['examid'];
    $sel="select * from examresult where id='$examid'";
	$res=$con->query($sel);
...
<h2 class="w3-center" style='color:#177F7D'><b>Update Exam Result</b></h2>
...
<div class="w3-row w3-section " style='width:60%;'>
  <div class="w3-col" style="width:50px;"></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="examid" type="text" readonly="readonly" value="<?php echo  $data['id'] ?>" placeholder="Exam ID " required>
    </div>
</div>
...
if(isset($_POST['update']))
{
  ...
  $examid=$_POST['examid'];
	...
	$result=$_POST['result'];
	echo $examid;
  $sql="Update examresult set sname='$sname', sid='$sid',  subject='$subject', result='$result' where id='$examid'";
