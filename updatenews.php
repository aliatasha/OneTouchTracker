...
<h2 class="w3-center" style='color:#177F7D'><b>Update School News</b></h2>
...
<div class="w3-row w3-section " style='width:60%;'>
  <div class="w3-col" style="width:50px;"></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name='newsid' type="text" value="<?php echo $data['newsid'] ?>" placeholder="Enter News ID" required>
    </div>
</div>
...
if(isset($_POST['update']))
{
	...
	if(empty($newsimage))
	{
	$sql="Update news set newsimage='$img',newstopic='$newstopic',newsdate='$newsdate',newsdesc='$newsdesc' where newsid='$newsid'";
	}
	else
	{
