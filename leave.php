...
<form method='POST' enctype="multipart/form-data">
  <div class="w3-padding-large" id="main">
    <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about"  style='width:100%; position: absolute; left: 58%; top: 45%; transform: translate(-50%, -50%);'>
    <center>
      <h2 class="w3-center" style='color:#177F7D'><b>Leave Application</b></h2>
      <br>
        <div>
          <?php
        ...
        <div class="w3-row w3-section" style='width:65%'>
