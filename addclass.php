...
<h2 class="w3-center" style='color:#177F7D'><b>Add School Details</b></h2>
...
<p class="w3-center">
<input type='submit' class="w3-button w3-section w3-teal w3-ripple" value='Add Details' name='add'>
</p>
</center>
...
//	$school=$_POST['school'];
	...
	$sql="Insert into class values('$cid','$grade','$class')";
