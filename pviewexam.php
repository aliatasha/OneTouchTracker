...
<form method='POST'>
<div class="w3-padding-large" id="main" style='position:absolute; top:35px; right: 430px;'>
<div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about"  style='width:130%'>
    <center>
	...
	<h2 class="w3-center" style='color:#177F7D'><b>View Examination Schedule</b></h2>
	   ...
	   <table class='w3-table-all w3-hoverable' border='1' cellspacing='0' cellpadding='0' width='130%' >
	   <thead>
