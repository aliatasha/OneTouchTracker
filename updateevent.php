...
<h2 class="w3-center" style='color:#177F7D'><b>Update School Event</b></h2>
...
if(isset($_POST['update']))
{
	...
	if(empty($eimage))
	{
	$sql="Update event set eimage='$img',eventname='$eventname',eventdate='$eventdate',eventtime='$eventtime' where eventid='$eventid'";
	}
	else
	{
