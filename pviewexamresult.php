...
<form method='POST'>
<div class="w3-padding-large" id="main" style='position:absolute; top:4px; left: 500px;'>
<div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about"  style='width:150%'>
    <center>
	<br>
    <br>
	<h2 class="w3-center" style='color:#177F7D'><b>View Examination Result</b></h2>
