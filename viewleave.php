...
<link rel="stylesheet"href="styles.css" >
  <link rel="stylesheet" href="w.css">
	...
	<h1 style='position: absolute; color:#177F7D; top: 20%; left: 700px;'><b>View Leave</b></h1>
	<div style="position: absolute; top: 30%; left: 230px;" class="container" >
		<div class="row">
			<div class="col">
				<table id="dataTables" class="table table-striped table-bordered" style="width:80%">
					<thead>
						<tr>
							<th>Student ID</th>
							<th>Leave Detail</th>
