...
<h2 class="w3-center" style='color:teal'><b>Add Class Timetable</b></h2>
...
<p class="w3-center">
<input type='submit' class="w3-button w3-section w3-teal w3-ripple" value='Add Timetable' name='add'>
</p>
</center>
...
$sql="Insert into sched values('$scid','$grade', '$class','$day','$time_start','$time_end','$subject','$teachername','$venue')";
