...
<form method='POST'>
<div class="w3-padding-large" id="main" style='position:absolute;  top: 60px; right:390px;'>
<div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about"  style='width:90%'>
    <center>
	
	<h2 style='color:#177F7D; position: relative; left: 150px;'><b>Student Details</b></h2>
