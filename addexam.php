...
<h2 class="w3-center" style='color:#177F7D'><b>Add Examination Schedule</b></h2>
...
$sql="INSERT into examsched (examid,grade, date,time_start,time_end,subject,venue) values('$examid','$grade','$date','$time_start','$time_end','$subject','$venue')";
