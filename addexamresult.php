...
<h2 class="w3-center" style='color:#177F7D'><b>Add Examination Result</b></h2>
...
<p class="w3-center">
<input type='submit' class="w3-button w3-section w3-teal w3-ripple" value='Add Result' name='add'>
...
if(isset($_POST['add']))
{
  ...
  $sql="Insert into examresult (sname,sid,subject,result) values('$sname','$sid','$subject','$result')";
