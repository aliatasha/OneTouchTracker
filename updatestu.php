...
<h2 class="w3-center" style='color:#177F7D'><b>Update Student</b></h2>
...
<div class="w3-row w3-section w3-center" style='width:60%'>
  <div class="w3-col" style="width:50px"></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="email" type="text" value="<?php echo $data['email'] ?>" placeholder="Enter Parents Email"  required>
    </div>
</div>
...
if(isset($_POST['update']))
{
	 $file=$_FILES['image']['tmp_name'];
		...
		$image=$iname;
					if(empty($image))
					{
					$sql="Update student set sname='$sname',image='$img',grade='$grade',class='$class',address='$address',pid='$pid',pname='$pname',contact='$contact',email='$email' where sid='$sid'";
					}
					else
					{
						$sql="Update student set sname='$sname',image='$image',grade='$grade',class='$class',address='$address',pid='$pid',pname='$pname',contact='$contact',,email='$email' where sid='$sid'";
					}
