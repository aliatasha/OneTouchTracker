...
<body>
	<?php 
		if(isset($_POST["link1"])){
			echo"<h1 style='position: absolute; color:#177F7D; top: 20%; left: 700px;'> <b>Current month: ".date('F')."</b></h1>";
		}
		else if(isset($_POST["link2"])){
			echo"<h1 style='position: absolute; color:#177F7D; top: 20%; left: 700px;'> <b>Current Year: ".date('Y')."</b></h1>";
		}
	?>
  <link rel="stylesheet"href="styles.css" >
  <link rel="stylesheet" href="w.css">
	...
	<form method="POST">
		...
		<div style="position: absolute; top: 30%; left: 260px;" class="container" >
			<div class="row">
				<div class="col">
