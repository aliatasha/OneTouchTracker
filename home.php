...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      ...
      <li>To update guardians the absence of their children through WhatsApp.</li>
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    ...
    <div class="col-sm-4">
      ...
      <p>Timetable, Exam Schedule and Exam Result</p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-wrench logo-small"></span>
      <h4 style="color:#303030;">COMMUNICATION API</h4>
...
<div class="parallax parallax3 padding-tb100 text-align-center margin-50" style="background:teal">
<div class="parallax parallax2 text-align-center">
    <div class="parallax-overlay padding-tb125">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <article class="quotes"> <i class="fa fa-quote-left fa-5x"></i>
                        <h2>Technology is just a tool. In terms of getting the kids working together and motivating them, the teacher is the most important thing.</h2>
                        <small>- Bill Gates</small> </article>
                </div>
            </div>
        </div>
    </div>
